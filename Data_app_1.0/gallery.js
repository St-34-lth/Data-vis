function Gallery() {
  ...
  this.addVisual = function(vis) 
  {
    ...
    // Check that the vis object has an id and name.
          ...
          if (vis.hasOwnProperty('preload') || vis['preload'])  //the has OwnProperty does not work on class/instance methods. This does.
  ...
  this.selectVisual = function(visId)
  {
          ...
          // If the current visualisation has a deselect method run it.
                    ...
                    && (this.selectedVisual.hasOwnProperty('destroy') ||  this.selectedVisual['destroy'])) //the has OwnProperty does not work on class/instance methods. This does.
                    {
          ...
          // Select the visualisation in the gallery.
                    ...
                    if (this.selectedVisual.hasOwnProperty('setup') || this.selectedVisual['setup'])  //the has OwnProperty does not work on class/instance methods. This does.
                    {
